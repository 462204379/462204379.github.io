    ...
    <el-container class="wrapper">
        <el-container class="container-box" v-bind:class="{'slide-hide': isCollapse, 'slide-in-left': menuShow}">
            <el-header class="header" style="padding: 0;">
                <div class="logo">
                    <!--图片logo-->
                    <div class="logoimg">SW</div>
                    <!--文字logo-->
                    <div class="logotext">
                        <div>电商高效工具</div>
                        <div>E-commerce tools</div>
                    </div>
                </div>
                <el-menu
                    class="el-menu-demo"
                    ...
                    style="border: none;display: flex;position: absolute;right: 120px;"
                    text-color="#000"
                ...
                <div class="header-right" v-if="userId">
                    <el-dropdown trigger="click">
                        ...
                        <span style="width: 100px;text-align: center;">{{username}}<i class="el-icon-arrow-down el-icon--right"></i></span>
