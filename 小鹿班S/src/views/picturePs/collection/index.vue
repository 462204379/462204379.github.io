<template>
    <div class="upTemplate" id="collection-upimg">
        <div class="nameImg">
        ...
        methods: {
            ...
            loadText() {
                ...
                $.each($(".textDiv"), function (i,v) {
                    that.listdata.map(item=>{
                        if(item.id == v.getAttribute("data-id")){
            ...
            okClick(val) {
                ...
                modifyPsdModel({list:itemlist,type :1})
                    .then(response => {
                        if(response.code){
                            return;
                        }
