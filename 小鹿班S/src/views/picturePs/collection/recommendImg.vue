    ...
    <div class="upTemplate" id="home-upimg">
        <div class="nameImg">
            ...
            <div style="display: flex;margin: 0 auto;align-items: center;">
                ...
                <div class="topList">
                    <el-dropdown placement="bottom" size="mini" @command="caozuoClick">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item command="1" v-if="thisdata == ''||thisAllid.length>0" disabled >复制 <span style="margin-left: 10px">ctrl + V</span></el-dropdown-item>
                            <el-dropdown-item command="1" v-else>复制 <span style="margin-left: 10px;color: #8FA0A9">ctrl + V</span></el-dropdown-item>
                            <el-dropdown-item command="2" v-if="thisdata == ''" disabled >删除 <span style="margin-left: 10px;">del</span></el-dropdown-item>
                            <el-dropdown-item command="2" v-else>删除 <span style="margin-left: 10px;color: #8FA0A9">del</span></el-dropdown-item>
                ...
                <div class="topList">
                    <div>
                        <i class="icon iconfont icon-dasan"></i>
                    </div>
                    <div>打散</div>
                </div>-->
                <!--<div class="topList noclick">
                    <div>
        ...
        <div class="addLeft">
                <div class="addLeft_list" @click="addimgVal.layerName='logo-请输入名称',UpDataVisible=true" ref="addLeftlist1" id="addLeftlist1">
                     <div><i class="icon iconfont icon-Ggooglelogo"></i></div>
                     <div style="margin-top: 5px">logo</div>
                </div>
                <div class="addLeft_list" @click="addimgVal.layerName='产品图-请输入名称',UpDataVisible=true">
                     <div><i class="icon iconfont icon-chanpin" style="font-size: 22px;"></i></div>
                     <div style="margin-top: 5px;">产品图</div>
                </div>
            <el-tooltip content="W" placement="right">
                <div slot="content" style="text-align: center;">快捷键<div style="color: #bebebe">W</div></div>
                <div class="addLeft_list" @click="addtext('文案-请输入名称')">
                    <div><i class="icon iconfont icon-wenanbiaoti" style="font-size: 14px;"></i></div>
                    <div style="margin-top: 5px;">文案</div>
                </div>
            </el-tooltip>
            <el-tooltip content="J" placement="right">
                <div slot="content" style="text-align: center;">快捷键<div style="color: #bebebe">J</div></div>
                <div class="addLeft_list" @click="addtext('价格-请输入价格')">
                    <div><i class="icon iconfont icon-jiage"></i></div>
                    <div style="margin-top: 5px;">价格</div>
                </div>
            </el-tooltip>
            <div class="addLeft_list" @click="addimgVal.layerName='额外-请输入名称',UpDataVisible=true">
                <div><i class="icon iconfont icon-tupian"></i></div>
                <div style="margin-top: 5px">额外</div>
            </div>
        </div>
        <div @mousedown="restoreAll" @mousedown.stop="addMoveLine($event)" style="width: 100%;right:100px;position: absolute;height: 100%;;top:120px;overflow: auto;" :style="{'min-height':mainHeight+'px','height':(height+132)+'px'}" v-loading="loading" element-loading-background="initial">
            ...
            <div>
                ...
                <div style="height: 40px;line-height: 40px;text-align: center;color: #fff;" class="tuijianTishi">
                    <ul style="display: inline-flex;">
                        <li>【图层差异】</li>
                        <li :class="{'errorColor':thisSortLogo.background != sortLogo.background}">背景：{{thisSortLogo.background}}
                            <span v-if="thisSortLogo.background != sortLogo.background">
                                <span v-show="thisSortLogo.background>sortLogo.background">(多{{thisSortLogo.background-sortLogo.background}})</span>
                                <span v-show="thisSortLogo.background<sortLogo.background">(少{{sortLogo.background-thisSortLogo.background}})</span>
                            </span>,</li>
                        <li :class="{'errorColor':thisSortLogo.product != sortLogo.product}">产品图：{{thisSortLogo.product}}
                            <span v-if="thisSortLogo.product != sortLogo.product">
                                <span v-show="thisSortLogo.product>sortLogo.product">(多{{thisSortLogo.product-sortLogo.product}})</span>
                                <span v-show="thisSortLogo.product<sortLogo.product">(少{{sortLogo.product-thisSortLogo.product}})</span>
                            </span>,</li>
                        <li :class="{'errorColor':thisSortLogo.logo != sortLogo.logo}">logo：{{thisSortLogo.logo}}
                            <span v-if="thisSortLogo.logo != sortLogo.logo">
                                <span v-show="thisSortLogo.logo>sortLogo.logo">(多{{thisSortLogo.logo-sortLogo.logo}})</span>
                                <span v-show="thisSortLogo.logo<sortLogo.logo">(少{{sortLogo.logo-thisSortLogo.logo}})</span>
                            </span>,</li>
                        <li :class="{'errorColor':thisSortLogo.price != sortLogo.price}">价格：{{thisSortLogo.price}}
                            <span v-if="thisSortLogo.price != sortLogo.price">
                                <span v-show="thisSortLogo.price>sortLogo.price">(多{{thisSortLogo.price-sortLogo.price}})</span>
                                <span v-show="thisSortLogo.price<sortLogo.price">(少{{sortLogo.price-thisSortLogo.price}})</span>
                            </span>,</li>
                        <li :class="{'errorColor':thisSortLogo.text != sortLogo.text}">文案：{{thisSortLogo.text}}
                            <span v-if="thisSortLogo.text != sortLogo.text">
                                <span v-show="thisSortLogo.text>sortLogo.text">(多{{thisSortLogo.text-sortLogo.text}})</span>
                                <span v-show="thisSortLogo.text<sortLogo.text">(少{{sortLogo.text-thisSortLogo.text}})</span>
                            </span>,</li>
                        <li :class="{'errorColor':thisSortLogo.extra != sortLogo.extra}">额外：{{thisSortLogo.extra}}
                            <span v-if="thisSortLogo.extra != sortLogo.extra">
                                <span v-show="thisSortLogo.extra>sortLogo.extra">(多{{thisSortLogo.extra-sortLogo.extra}})</span>
                                <span v-show="thisSortLogo.extra<sortLogo.extra">(少{{sortLogo.extra-thisSortLogo.extra}})</span>
                            </span></li>
                    </ul>
                </div>
            <div id="moveCard" :style="{'background':bgurl,'background-color':bgcolor,'width':width+'px','height':height+'px','margin-top':marginTop-20+'px'}">
        ...
        <div class="rightForm" :style="{'min-height':mainHeight+'px','height':(height+132)+'px'}" v-if="rightForm_1==true">
            <div v-if="formTitle == '图片编辑'">
                ...
                <el-form @change="updataform" ref="formData" :model="formData" label-width="60px" label-position="left" size="mini" style="overflow: auto;" :style="{'height':mainHeight-70+'px'}">
                    <el-form-item label="名称">
                        <el-input v-model="formData.layerName" @focus="guangbiao=true" @blur="guangbiao=false" @change="numberIndex_b += 1,cunchuData(),thisActiveListSort()"></el-input>
                    </el-form-item>
        ...
        <div class="rightForm" style="width: 50px;text-align: center;" :style="{'min-height':mainHeight+'px','height':(height+132)+'px'}" v-else>
        ...
        <transition name="el-zoom-in-top">
            <div class="rightForm rightForm_2" :style="{'min-height':mainHeight+'px','height':(height+132)+'px'}" :class="{rightForm_2_right:rightForm_1==false}" v-if="rightForm_2">
            ...
            <div class="rightForm rightForm_2" style="width: 50px;text-align: center;" :class="{rightForm_2_right:rightForm_1==false}" :style="{'min-height':mainHeight+'px','height':(height+132)+'px'}" v-else>
        ...
        <div class="baocunSub" style="text-align: center;position: fixed;bottom: 20px;width: 100%;right: 100px;" v-if="loading==false" v-show="okSubmit">
            <ul>
                <li @click.stop="thisActiveClick(index)" :class="{'thisActive':modelIdIndex==index}" v-for="(item, index) in modelIds" :key="index">
                    {{index+1}}
                    <div @click.stop="removeActiveClick(index)">
                        <i class="el-icon-circle-check" style="color: #67C23A" v-if="thisSortLogoType[index]==1"></i>
                        <i class="el-icon-circle-close" style="color: #F56C6C" v-else-if="thisSortLogoType[index]==0"></i>
                        <i class="el-icon-circle-check" v-else style="color: #909399"></i>
                    </div>
                </li>
            </ul>
            <el-button type="primary" size="mini" @click="noClick">取消修改</el-button>
            <el-button type="primary" size="mini" @click="okClick">全部修改完毕</el-button>
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            bgurl: "",
            mainHeight: "",
            modelId: Number(this.$route.query.id.split(",")[0]),
            thisSortLogoType: [],
            modelIdIndex:0,
            modelIds: this.$route.query.id.split(","),
            thisActiveList:[],
            sortLogo: JSON.parse(this.$route.query.sortLogo),
            thisSortLogo: {
                background: 0,
                product: 0,
                logo: 0,
            ...
            textVal: JSON.parse(this.$route.query.textVal),
            username: JSON.parse(this.$route.query.textVal)[0].username,
            width: Number(JSON.parse(this.$route.query.textVal)[0].width),
            height: Number(JSON.parse(this.$route.query.textVal)[0].height),
            bgcolor: "#fff",
            rightTable: false,
            addtextVal: {
                rightBox: "",
    ...
    methods: {
        removeActiveClick(index){
            ...
            this.$confirm('是否确认删除该模板?', '提示', {
                ...
                this.thisActiveList.splice(index, 1);
                this.modelId = this.modelIds[0];
                this.textVal.splice(index, 1);
                this.username=this.textVal[0].username;
                this.width=this.textVal[0].width;
                this.height=this.textVal[0].height;
                if(index==0&&this.thisActiveList.length==0){
                    this.thisSortLogo.background = 0;
                    this.thisSortLogo.product = 0;
                    this.thisSortLogo.logo = 0;
                    this.thisSortLogo.price = 0;
                    this.thisSortLogo.text = 0;
                    this.thisSortLogo.extra = 0;
                    this.indexAxios();
                }else{
                    this.listdata = this.thisActiveList[0];
                    this.thisActiveType();
                }
                this.$message({
                    type: 'success',
        ...
        thisActiveClick(index) {
            if(index == this.modelIdIndex) {
                return;
            }
            this.restoreAll();
            this.username = this.textVal[index].username;
            this.width = this.textVal[index].width;
            this.height = this.textVal[index].height;
            this.modelIdIndex = index;
            this.modelId = this.modelIds[index];
            if (this.thisActiveList[index]) {
                this.listdata = this.thisActiveList[index];
                this.thisActiveListSort();
            } else {
                this.thisSortLogo.background = 0;
                this.thisSortLogo.product = 0;
                this.thisSortLogo.logo = 0;
        ...
        thisActiveType() {
            let number = [];
            this.thisSortLogoType = [];
            this.modelIds.map((item, index)=>{
                this.thisSortLogoType[index] = 2;
                number.push([0,0,0,0,0,0]);
            })
            this.modelIds.map((items, ind)=>{
                if(this.thisActiveList[ind]){
                    this.thisActiveList[ind].map((item, index)=> {
                        if(item.layerName.split("-")[0] == "背景"){
                            number[ind][0]+=1;
                        }
                        if(item.layerName.split("-")[0] == "产品图"){
                            number[ind][1]+=1;
                        };
                        if(item.layerName.split("-")[0] == "logo"){
                            number[ind][2]+=1;
                        };
                        if(item.layerName.split("-")[0] == "价格"){
                            number[ind][3]+=1;
                        };
                        if(item.layerName.split("-")[0] == "文案"){
                            number[ind][4]+=1;
                        };
                        if(item.layerName.split("-")[0] == "额外"){
                            number[ind][5]+=1;
                        };
                    });
                    if(number[ind][0] == this.sortLogo.background&&number[ind][1] == this.sortLogo.product&&number[ind][2] == this.sortLogo.logo&&number[ind][3] == this.sortLogo.price&&number[ind][4] == this.sortLogo.text&&number[ind][5]== this.sortLogo.extra){
                        this.thisSortLogoType[ind] = 1;
                    } else {
                        this.thisSortLogoType[ind] = 0;
                    }
                } else {
                    this.thisSortLogoType[ind] = 2;
                }
            })
        },
        thisActiveListSort() {
            ...
            this.listdata.map((item, index)=> {
                if(item.layerName.split("-")[0] == "背景"){
                    this.thisSortLogo.background+=1;
                }
                if(item.layerName.split("-")[0] == "产品图"){
                    this.thisSortLogo.product+=1;
                };
                if(item.layerName.split("-")[0] == "logo"){
                    this.thisSortLogo.logo+=1;
                };
                if(item.layerName.split("-")[0] == "价格"){
                    this.thisSortLogo.price+=1;
                };
                if(item.layerName.split("-")[0] == "文案"){
                    this.thisSortLogo.text+=1;
                };
                if(item.layerName.split("-")[0] == "额外"){
                    this.thisSortLogo.extra+=1;
                };
            });
            this.thisActiveType();
        },
        ...
        indexAxios() {
            ...
            psdTemplateItem(form)
                .then(response => {
                    ...
                    this.cunchuData();
                    this.thisActiveList[this.modelIdIndex] = this.listdata;
                    this.thisActiveType();
                })
                .catch(() => {
        ...
        caozuoClick(command) {
            if(command === "1"){
                let copydata = JSON.parse(JSON.stringify(this.thisdata));
                copydata.topBox += 5;
                copydata.leftBox += 5;
                let number = [];
                this.listdata.map(item =>{
                ...
                copydata.id = "";
                copydata.layerId = Number(Math.max(...number)) + 1;
                this.listdata.push(copydata)
                this.thisActiveListSort();
            } else if(command === "2"){
                this.removeIT();
            } else if(command === "3") {
        ...
        addtext(val) {
            this.addtextVal.layerName = val;
            var addText = JSON.stringify(this.addtextVal);
            ...
            addText.layerId = Number(Math.max(...number)) + 1;
            this.listdata.unshift(addText);
            this.thisdataid = 0;
            this.formData = addText;
            this.formTitle = "文案编辑";
            this.thisAllid = [];
            this.numberIndex_b += 1;
            this.cunchuData();
        ...
        removeIT() {
            if(this.thisAllid.length > 0){
                ...
                this.listdata = removedata;
                this.thisAllid = [];
                this.numberIndex_b += 1;
                this.cunchuData();
            } else {
                this.listdata.splice(this.thisdataid, 1);
                this.formTitle = "";
                this.thisdataid = "-1";
                this.numberIndex_b += 1;
                this.cunchuData();
        ...
        okClick(val) {
            let submit = true;
            console.log(this.thisSortLogoType)
            this.thisSortLogoType.map((item)=>{
                if(item != 1){
                    submit = false;
                }
            })
            if(submit==false){
                this.$message.error("图层有差异，请修改完整后提交");
                return;
            }
            let thisActiveList = JSON.parse(JSON.stringify(this.thisActiveList));
            thisActiveList.map(data=>{
                data = data.reverse();
                data.map(item=>{
                    if (item.imageUrl == null){
                        item.leftBox += 10;
            ...
            modifyPsdModelBatch({list:thisActiveList})
                .then(response => {
                    if(response.code){
                        return;
                    }
        ...
        $("body").keydown(function(event){
            ...
            switch(e.keyCode){
                ...
                case 67:
                    break;
                case 87:
                    that.addtext('文案-请输入名称');
                    break;
                case 74:
                    that.addtext('价格-请输入价格')
                    break;
                case 69:
                    break;
                default:
