    ...
    methods: {
        ...
        fanhuiClick (){
            this.$confirm('是否返回，返回后系统可能不会保存您所做的更改?', '提示', {
                ...
                this.$router.push({ path: '/picturePs/index/home',query:{activeName:this.activeName}});
            }).catch(() => {
                this.$message({
                    type: 'info',
                    message: '已取消'
        ...
        indexAxios() {
            ...
            this.addtextVal.modelId = this.$route.query.id;
            this.addimgVal.modelId = this.$route.query.id;
        ...
        okClick(val) {
            ...
            modifyPsdModel({list:itemlist,type :0})
                .then(response => {
                    if(response.code){
                        return;
                    }
                    if(val == 0){
                        ...
                        this.$router.push({ path: "/picturePs/index/home",query:{activeName:"5"}});
                    }
                })
                .catch(() => {});
        },
